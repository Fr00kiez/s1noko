<div class="d-flex flex-column p-3" id="admin-sidebar" style="width: 120px; background-color: #1e3344;">
    ...
    <div class="mt-auto p-2">
        <a href="{{ route('logout') }}" class="d-flex flex-column align-items-center">
            <svg width="31" height="36" viewBox="0 0 31 36" xmlns="http://www.w3.org/2000/svg" class="mb-2" fill="currentColor">
